 ...
 * });
 */
export declare function useWatchSipLineData(props: {
    key: {
...
export declare function useWatchSipLineData<P extends Path<SipLineDataType>>(props: {
    key: {
        lineKey: LineType['lineKey'];
    };
    name: P;
...
export declare function useWatchSipLineData<const P extends readonly Path<SipLineDataType>[]>(props: {
    key: {
        lineKey: LineType['lineKey'];
    };
    name: P;
