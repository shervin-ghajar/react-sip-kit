 ...
 * });
 */
export declare function useWatchJanusLineData(props: {
    key: {
...
export declare function useWatchJanusLineData(props: {
    key: {
        remoteNumber: JanusLineDataType['remoteNumber'];
        configKey: RtcConfig['key'];
    };
    name?: undefined;
}): JanusLineDataType;
export declare function useWatchJanusLineData<P extends Path<JanusLineDataType>>(props: {
    key: {
        lineKey: LineType['lineKey'];
    };
    name: P;
...
export declare function useWatchJanusLineData<const P extends readonly Path<JanusLineDataType>[]>(props: {
    key: {
        lineKey: LineType['lineKey'];
    };
    name: P;
