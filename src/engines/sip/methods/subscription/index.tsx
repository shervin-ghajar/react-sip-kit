...
//   const { buddies } = getRtcStore();
//   let clonedUserAgent = userAgent ?? clone(getEngineInstance());
...
//     }
//   }
//   if (!userAgent) setRtcStore({ userAgent: clonedUserAgent });
// }

// export function SelfSubscribe(userAgent?: SipUserAgent) {
//   const { sipDomain, sipUsername, userAgent: storeUserAgent } = getRtcStore();
...
//   const { sipDomain, userAgent: storeUserAgent } = getRtcStore();
//   let clonedUserAgent = userAgent ?? clone(storeUserAgent);
//   if (!clonedUserAgent?.isRegistered()) return;
